...
function SideNav({ mobileOpen, setMobileOpen }) {
  ...
  let listItemData = [
...

    {
      ...
      link: "/admin/subcription-management",
      ...
      children: [
        {
          ...
          link: "/admin/musician-payouts",
        },
        {
          label: "Refund Payment Request",
          link: "/admin/refund-payment-request",
        },
        {
          label: "Bank Details",
