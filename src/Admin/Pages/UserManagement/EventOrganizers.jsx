...
import ProfileModal from "../../Modals/EventOrganizerProfileModal";
import "../../../App.css";
...
const EventOrganizers = () => {
  ...
  const menuItems = ["Block", "Active", "Male", "Female"];
  ...
  return (
    <div className="container-fluid" style={{ color: "#f5f5f5" }}>
      ...
      <div className="pagination justify-content-end align-items-end mt-2 me-1">
        <Paginate
