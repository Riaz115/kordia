...
import EditContractModal from "../../../Admin/Modals/EditContractModal";
...
const ContractTab = () => {
  ...
  const handleOpenEditContractModal = () => setShowEditContractModal(true);
  const handleCloseEditContractModal = () => setShowEditContractModal(false);  const totalItems = 1000;
  ...
  const handleEdit = () => {
    // Implement edit functionality here, if necessary
    handleOpenEditContractModal();  // Open the modal when edit is triggered
    handleMenuClose();  // Close the menu (assuming you're also handling the menu closing)
  };
  ...
  return (
    <div className="container-fluid">
      ...
      <EditContractModal
        ...
        handleClose={handleCloseEditContractModal}
      />
