...
const PricingPlan = () => {
  ...
  const handlePlanSelection = (tab, index) => {
    setSelectedPlan({ tab, index });
  };
        ...
        >
          ...
          />
            ...
            sx={{
              ...
              color: activeTab === 2 ? "#034F75" : "#034F75",
          ...
          />
            ...
            sx={{
              ...
              flex: 1,
              px: 2,
              backgroundColor: activeTab === 3 ? "#FFFFFF" : "transparent",
              color: activeTab === 3 ? "#034F75" : "#034F75",
              ...
              {plansmonth.map((plan, index) => (
                <Grid item xs={12} sm={6} md={6} lg={4} key={index}>
                  ...
                  >
                    ...
                    <img style={{ width: "100px" }} src={klogo} alt="img" />
                    <p className="mt-4">
                    ...
                    <button
                      className="bg-main-orange rounded-4 w-100 text-white font-poppins"
                      style={{
                        padding: "10px",
                        fontSize: "16px",
                        border: "none",
                        fontWeight: "500",
                        backgroundColor:
                          selectedPlan.tab === "monthly" &&
                          selectedPlan.index === index
                            ? "#DA8A15"
                            : "#FF9700", // Change color if selected
                      }}
                      onClick={() => handlePlanSelection("monthly", index)}
                    >
                      Select Plan
                    </button>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: "500",
                        backgroundColor:
                          selectedPlan.tab === "quarterly" &&
                          selectedPlan.index === index
                            ? "#DA8A15"
                            : "#FF9700", // Change color if selected
                      }}
                      onClick={() => handlePlanSelection("quarterly", index)}
                    >
                      Select Plan
                    </button>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: "500",
                        backgroundColor:
                          selectedPlan.tab === "biannually" &&
                          selectedPlan.index === index
                            ? "#DA8A15"
                            : "#FF9700", // Change color if selected
                      }}
                      onClick={() => handlePlanSelection("biannually", index)}
                    >
                      Select Plan
                    </button>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: "500",
                        backgroundColor:
                          selectedPlan.tab === "annually" &&
                          selectedPlan.index === index
                            ? "#DA8A15"
                            : "#FF9700", // Change color if selected
                      }}
                      onClick={() => handlePlanSelection("annually", index)}
                    >
                      Select Plan
                    </button>
