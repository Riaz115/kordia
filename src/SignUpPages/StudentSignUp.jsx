...
const StudentSignUp = () => {
  ...
  const renderContent = () => {
    switch (step) {
      case 1:
        return {
          leftHeading: "Sign up As Student",
      ...
      case 3:
        return {
          ...
          leftSubText:
            "You're now part of a community of learners ready to unlock their potential. Start your learning journey today with our wide range of courses.",
          progress: 100,
        };
      default:
        return {};
  ...
  const renderStepContent = () => {
    switch (step) {
      case 1:
        return <SignUpForm />;
      case 2:
        return <MusicGenres studioservicesList={studioservicesList} />;
      case 3:
      ...
      >
        ...
        >
          ...
          <Box
            sx={{
              display: "flex",
              justifyContent: step === 3 ? "flex-end" : "space-between",
            }}
          >
            <Button
              onClick={handleBack}
            ...
            >
              <Button
                onClick={() =>
                  step === 3 ? navigate("/my-learning") : handleNext()
                }
                variant="contained"
                sx={{
                  backgroundColor: "#FF9700",
